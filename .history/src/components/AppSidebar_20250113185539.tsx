        ...
        {showHelpModal && (
          <div className="fixed inset-0 flex justify-center items-center bg-gray-500 bg-opacity-50 z-50">
            <div className="bg-white p-6 rounded-md shadow-lg w-96">
              ...
              <div className="my-4">
                <label htmlFor="question" className="block text-sm font-medium text-gray-700">Select a Question</label>
                <select
                  id="question"
              ...
              {selectedQuestion && (
                <div className="my-4">
                  <label htmlFor="sub-question" className="block text-sm font-medium text-gray-700">Select Sub-question</label>
                  <select
                    id="sub-question"
                    className="w-full mt-2 p-2 border border-gray-300 rounded-md"
                  >
              ...
              <div className="my-4">
                <label htmlFor="user-query" className="block text-sm font-medium text-gray-700">Your Query</label>
                <textarea
                  id="user-query"
                  value={userQuery}
